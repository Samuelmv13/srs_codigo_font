...
function DataView_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassMap("ui-dataview-loading-icon pi-spin " + ctx_r183.loadingIcon);
} }
function DataView_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r190); var ctx_r189 = ɵngcc0.ɵɵnextContext(); return ctx_r189.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r184 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r184.rows)("first", ctx_r184.first)("totalRecords", ctx_r184.totalRecords)("pageLinkSize", ctx_r184.pageLinks)("alwaysShow", ctx_r184.alwaysShowPaginator)("rowsPerPageOptions", ctx_r184.rowsPerPageOptions)("dropdownAppendTo", ctx_r184.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r184.paginatorDropdownScrollHeight)("templateLeft", ctx_r184.paginatorLeftTemplate)("templateRight", ctx_r184.paginatorRightTemplate)("currentPageReportTemplate", ctx_r184.currentPageReportTemplate)("showCurrentPageReport", ctx_r184.showCurrentPageReport);
} }
...
function DataView_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    var rowData_r191 = ctx.$implicit;
    var rowIndex_r192 = ctx.index;
    var ctx_r185 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r185.itemTemplate)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(2, _c0, rowData_r191, rowIndex_r192));
} }
function DataView_div_10_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r186.emptyMessage);
} }
function DataView_p_paginator_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function DataView_p_paginator_11_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r195); var ctx_r194 = ɵngcc0.ɵɵnextContext(); return ctx_r194.paginate($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r187 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("rows", ctx_r187.rows)("first", ctx_r187.first)("totalRecords", ctx_r187.totalRecords)("pageLinkSize", ctx_r187.pageLinks)("alwaysShow", ctx_r187.alwaysShowPaginator)("rowsPerPageOptions", ctx_r187.rowsPerPageOptions)("dropdownAppendTo", ctx_r187.paginatorDropdownAppendTo)("dropdownScrollHeight", ctx_r187.paginatorDropdownScrollHeight)("templateLeft", ctx_r187.paginatorLeftTemplate)("templateRight", ctx_r187.paginatorRightTemplate)("currentPageReportTemplate", ctx_r187.currentPageReportTemplate)("showCurrentPageReport", ctx_r187.showCurrentPageReport);
} }
