...
function MenuItemContent_a_0_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r159.item.icon);
} }
...
function MenuItemContent_a_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_0_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r161); var ctx_r160 = ɵngcc0.ɵɵnextContext(); return ctx_r160.menu.itemClick($event, ctx_r160.item); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(9, _c1, ctx_r157.item.disabled));
    ɵngcc0.ɵɵattribute("href", ctx_r157.item.url || null, ɵngcc0.ɵɵsanitizeUrl)("tabindex", ctx_r157.item.disabled ? null : "0")("data-automationid", ctx_r157.item.automationId)("target", ctx_r157.item.target)("title", ctx_r157.item.title)("id", ctx_r157.item.id);
    ɵngcc0.ɵɵadvance(1);
...
function MenuItemContent_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r162.item.icon);
} }
...
function MenuItemContent_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function MenuItemContent_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r164); var ctx_r163 = ɵngcc0.ɵɵnextContext(); return ctx_r163.menu.itemClick($event, ctx_r163.item); });
    ...
    ɵngcc0.ɵɵproperty("routerLink", ctx_r158.item.routerLink)("queryParams", ctx_r158.item.queryParams)("routerLinkActive", "ui-menuitem-link-active")("routerLinkActiveOptions", ctx_r158.item.routerLinkActiveOptions || ɵngcc0.ɵɵpureFunction0(18, _c2))("ngClass", ɵngcc0.ɵɵpureFunction1(19, _c1, ctx_r158.item.disabled))("fragment", ctx_r158.item.fragment)("queryParamsHandling", ctx_r158.item.queryParamsHandling)("preserveFragment", ctx_r158.item.preserveFragment)("skipLocationChange", ctx_r158.item.skipLocationChange)("replaceUrl", ctx_r158.item.replaceUrl)("state", ctx_r158.item.state);
    ɵngcc0.ɵɵattribute("data-automationid", ctx_r158.item.automationId)("target", ctx_r158.item.target)("id", ctx_r158.item.id)("tabindex", ctx_r158.item.disabled ? null : "0")("title", ctx_r158.item.title);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r158.item.icon);
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(ctx_r158.item.label);
} }
var _c3 = ["container"];
...
function Menu_div_0_3_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r170 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, submenu_r170.visible === false));
} }
function Menu_div_0_3_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r170 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(3, _c4, submenu_r170.visible === false));
    ɵngcc0.ɵɵattribute("data-automationid", submenu_r170.automationId);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(submenu_r170.label);
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r170 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r176.visible === false || submenu_r170.visible === false));
} }
function Menu_div_0_3_ng_template_0_ng_template_2_li_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r176)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r176.visible === false || submenu_r170.visible === false))("ngStyle", item_r176.style);
} }
...
function Menu_div_0_3_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var submenu_r170 = ctx.$implicit;
    ɵngcc0.ɵɵproperty("ngIf", submenu_r170.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !submenu_r170.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", submenu_r170.items);
} }
...
function Menu_div_0_4_ng_template_0_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r184 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(1, _c4, item_r184.visible === false));
} }
function Menu_div_0_4_ng_template_0_li_1_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵelement(0, "li", 10);
} if (rf & 2) {
    var item_r184 = ɵngcc0.ɵɵnextContext().$implicit;
    ɵngcc0.ɵɵclassMap(item_r184.styleClass);
    ɵngcc0.ɵɵproperty("pMenuItemContent", item_r184)("ngClass", ɵngcc0.ɵɵpureFunction1(5, _c4, item_r184.visible === false))("ngStyle", item_r184.style);
} }
function Menu_div_0_4_ng_template_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngIf", item_r184.separator);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !item_r184.separator);
} }
...
function Menu_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Menu_div_0_Template_div_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r190); var ctx_r189 = ɵngcc0.ɵɵnextContext(); return ctx_r189.preventDocumentDefault = true; })("@overlayAnimation.start", function Menu_div_0_Template_div_animation_overlayAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r190); var ctx_r191 = ɵngcc0.ɵɵnextContext(); return ctx_r191.onOverlayAnimationStart($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction1(8, _c5, ctx_r165.popup))("ngStyle", ctx_r165.style)("@overlayAnimation", ɵngcc0.ɵɵpureFunction1(13, _c7, ɵngcc0.ɵɵpureFunction2(10, _c6, ctx_r165.showTransitionOptions, ctx_r165.hideTransitionOptions)))("@.disabled", ctx_r165.popup !== true);
    ɵngcc0.ɵɵadvance(3);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r165.hasSubMenu());
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", !ctx_r165.hasSubMenu());
} }
